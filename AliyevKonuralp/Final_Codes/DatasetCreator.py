...
class bdd100kDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, image_dir,image_files, labels_of_image, instance_classes, class_to_category,category_map, transform=None):
        self.image_dir = image_dir
        self.image_files=image_files
        self.labels_of_image = labels_of_image
        self.instance_classes = instance_classes
        self.class_to_category = class_to_category
        self.category_map=category_map
        self.transform = transform
    ...
    def __getitem__(self, idx):
        ...
        labels = self.labels_of_image[idx]
        ...
        target = extract_bboxes_from_instanceIdsBdd100k(labels, self.instance_classes, self.class_to_category,self.category_map)
        target['boxes']=AdjustBoundingBoxes(target['boxes'], scale_x, scale_y)
