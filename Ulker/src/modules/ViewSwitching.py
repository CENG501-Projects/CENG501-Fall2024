...
class ViewSwitcher(nn.Module):
    def __init__(self, threshold):
        ...
        # Operations
        self.adaptive_pool = torch.nn.AdaptiveAvgPool2d(output_size=(20, 20))
        ...
        model_path = os.path.join(os.getcwd(), "superpoint_v1.pth")
    ...
    def forward(self, feature_map1, feature_map2):
        ...
        # Correlation
        cross_correlation_map = torch.matmul(feature_map_1a, feature_map_2a.transpose(-1, -2))  # transpose of last 2 channels
        ...
        return sparse_features, smaller_scale_map

        


model = ViewSwitcher(0.5)