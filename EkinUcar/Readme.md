...
<img width="700" alt="LRA parameters" src="https://github.com/user-attachments/assets/ad5f033b-7d65-49b5-af5a-d59dce0dd289">
...
<u>Batch size:<\u> Due to GPU RAM constraints, we reduced the batch size from 50 to 10.  
<u>Number of epochs:<\u> We reduced the number of epochs due to time constraints. We did 2 experiments: (i) With the full sMNIST dataset and 2 epochs. (ii) With 1/20 of the sMNIST dataset and 80 epochs.
