...
class ASPP(nn.Module):
    ...
    def forward(self, x):
        ...
        gap_output = F.interpolate(gap_output, size=(h, w), mode='bilinear', align_corners=False)
        
        concat_features = torch.cat([conv1x1_output] + dilated_outputs + [gap_output], dim=1)
